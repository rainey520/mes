package com.ruoyi.project.quality.mesBatch.mapper;
...
public interface MesBatchMapper {
     ...
     * @return 结果
     */
    List<MesBatch> selectMesBatchListByWorkCode(@Param("companyId") Integer companyId, @Param("workCode") String workCode);
